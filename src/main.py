...
# El tiempo estimado para la ejecución es aproximadamente 8h: 4h para obtener el total de los datos de Europa y 4h para el scraping de los buques de España.

# Obtener datos de los buques de Europa
scrap.get_data_EU()
